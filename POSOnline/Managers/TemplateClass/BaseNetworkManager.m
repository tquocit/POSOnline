...
- (void)sendRequest:(NSURLRequest *)request success:(void (^)(id responseObject))success failure:(void (^)(NSError *error))failure
{
  ...
  [AFJSONRequestOperation JSONRequestOperationWithRequest:request success:^(NSURLRequest *request, NSHTTPURLResponse *response, id json) {
    ...
    DLog(@"%@", json ?: [response allHeaderFields]);
    if (failure)
      failure(error);
                           ...
                           failure:(void (^)(NSError *error))failure
{
  ...
  [self sendRequest:request success:^(NSDictionary *json) {
    ...
    if ([json isKindOfClass:[NSDictionary class]] == YES)
    {
      ...
      id arr = [json objectForKey:keyToLookFor];
      if (arr != nil)
        rawArray = arr;
    }
    else
    {
      rawArray = (NSArray*)json;
    }
                           ...
                           failure:(void (^)(NSError *error))failure
{
  ...
  [self sendRequest:request success:^(NSDictionary *json) {
    ...
    NSDictionary *rawDictionary = (NSDictionary*)json;
